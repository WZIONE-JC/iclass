...
function stop(obj,id){
    layer.confirm('确认要关闭吗？',function(index){
        ...
        $(obj).parents("tr").find(".td-status").html('<span class="label label-default radius" title="已关闭">已关闭</span>');
        $(obj).remove();
...
function start(obj,id){
    layer.confirm('确认要发布吗？',function(index){
        $(obj).parents("tr").find(".td-manage").append(" <a style='text-decoration:none' class='ml-5' onClick='stop(this,"+id+")' title='关闭'><i class='Hui-iconfont'>&#xe6de;</i></a>");
